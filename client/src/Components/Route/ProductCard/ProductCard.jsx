    ...
    return (
        <div className='w-full h-[370px] bg-white rounded-lg shadow-sm p-3 relative cursor-pointer'>
            ...
            <Link to={`/product/${product_name}`}>
                <img src={data.image_Url[0].url} className='w-full h-[170px] object-contain' alt='' />
            </Link>
            <Link to='/'>
            ...
            <Link to={`/product/${product_name}`}>
                ...
                <div className="flex">
                    <AiFillStar className='m-2 cursor-pointer' color='#F6BA00' size={20} />
                    <AiFillStar className='m-2 cursor-pointer' color='#F6BA00' size={20} />
                    <AiFillStar className='m-2 cursor-pointer' color='#F6BA00' size={20} />
                    <AiFillStar className='m-2 cursor-pointer' color='#F6BA00' size={20} />
                    <AiOutlineStar className='m-2 cursor-pointer' color='#F6BA00' size={20} />
                </div>
